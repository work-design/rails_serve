Rails.application.routes.draw do
  ...
  scope :panel, module: 'roled/panel', as: :panel, defaults: { business: 'roled', namespace: 'panel' } do
    resources :roles do
      member do
        post :overview
        post :namespaces
  ...
  scope :admin, module: 'roled/admin', as: :admin, defaults: { business: 'roled', namespace: 'admin' } do
